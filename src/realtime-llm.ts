  ...
  async *streamResponse(userMessage: string) {
    ...
    const stream = await this.openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "Ты дружелюбный русскоговорящий ассистент. Твоя задача - красиво и грамотно озвучить ответ другого ассистента, разбивая его на удобные для произношения части. Отвечай без вводных слов, сразу транслируй переданный текст"
        },
        { 
          role: "user", 
